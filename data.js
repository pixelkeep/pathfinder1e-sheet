...
const FEATS_DB = [
  ...
  { name:'Toughness',             type:'general', prereqs:'None',
    benefit:'+3 HP, +1 HP per HD beyond 3.' },
  ...
  { name:'Iron Will',             type:'general', prereqs:'None',
    benefit:'+2 on Will saving throws.' },
  { name:'Lightning Reflexes',    type:'general', prereqs:'None',
    benefit:'+2 on Reflex saving throws.' },
  { name:'Great Fortitude',       type:'general', prereqs:'None',
    benefit:'+2 on Fortitude saving throws.' },
  ...
  { name:'Improved Initiative',   type:'general', prereqs:'None',
